# OpenCore EFI for AMD Ryzen Custom macOS [![tests](https://github.com/subhead/opencore-ryzen-macos/actions/workflows/tests.yml/badge.svg)](https://github.com/subhead/opencore-ryzen-macos/actions/workflows/tests.yml)
